                ...
                <div class="container">
                    ...
                    <div class="d-flex flex-column justify-content-center">
                        <div class="container d-flex flex-row justify-content-center" style="height:35px;line-height:24px;/*border-radius:2;*/">
                        			<input name="data[search]" class="form-control" id="search" type="text" placeholder="Digite o título do tema (deixe vazio para trazer todos)" style="border-radius:20px;">
